(function(e) {
    ...
    "56d7": function(e, t, s) {
        ...
        var a = s("d1e1"),
            n = (s("81e6"), s("9ffb")),
            c = (s("e260"), s("e6cf"), s("cca6"), s("a79d"), s("2b0e")),
            i = function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
            ...
            l = o,
            d = (s("034f"), s("2877")),
            u = Object(d["a"])(l, i, r, !1, null, null, null),
            A = u.exports,
            f = s("8c4f"),
            b = function() {
                var e = this,
                ...
                return a("div", [a("div", {
                ...
                }, [e._v("")]), a("span", [e._v("码通")])])], 1), a("div", {
                    staticClass: "avatar"
                }, [e.userInfo.faceImg && "null" !== e.userInfo.faceImg ? a("img", {
                    attrs: {
                        src: e.userInfo.faceImg,
                        alt: "头像加载失败"
                    }
                }) : a("span", {
                    staticClass: "iconfont iconfont-img"
                }, [e._v("")])]), a("div", {
                    staticClass: "user"
                }, [a("span", {
                    staticClass: "name"
                }, [e._v(e._s(e.userInfo.userName ? e.userInfo.userName : "获取失败"))]), a("span", {
                    staticClass: "code"
                }, [e._v(e._s(e.userInfo.userCode ? e.userInfo.userCode : "获取失败"))])])], 1), a("div", {
                    staticClass: "content"
                }, [a("div", {
                    staticClass: "qr-code",
                    on: {
                    ...
                    staticClass: "code code-fail"
                }, [e._v("获取失败")]), a("span", {
                    staticClass: "time",
                    staticStyle: {
                        "'color": "#f2f2f2"
                    }
                }, [e._v(e._s(e.time))])]), a("div", {
                    staticClass: "pass"
                }, [e._m(0), a("div", {
                    staticClass: "main"
                }, [a("span", [e._v("通行权限：")]), "yes" === e.pass ? a("span", {
                    staticClass: "green"
                }, [e._v("允许")]) : e._e(), "no" === e.pass ? a("span", {
                    staticClass: "red"
                }, [e._v("禁止 "), a("span", {
                    staticClass: "no-tell"
                }, [e._v("*" + e._s(e.passText) + "*")])]) : e._e(), "" === e.pass ? a("span", {
                    staticClass: "grey"
                }, [e._v("获取失败")]) : e._e()])]), a("div", {
                    staticClass: "record"
                }, [a("div", {
                    staticClass: "title"
                }, [e._v("新冠疫苗接种记录")]), 0 !== e.vaccinationList.length ? a("div", e._l(e.vaccinationList, (function(t, s) {
                    return a("div", {
                        key: s,
                        staticClass: "one"
                    }, [a("div", {
                        ...
                        staticClass: "iconfont"
                    }, [e._v("")]), a("span", [e._v("第" + e._s(t.attributes.dose) + "针")])]), a("div", {
                        staticClass: "right"
                    }, [e._v(e._s(t.attributes.date))])])
                })), 0) : a("div", {
                    staticStyle: {
                        color: "#949494"
                    }
        ...
        var z = {
                ...
                methods: {
                    ...
                    getPriority: function() {
                        ...
                        G().then((function(t) {
                            ...
                            e.pass = "yes", e.passColor = "#3fca72", e.getUserCode()
                        }))
                    },
                    goUrl: function(e) {
                        window.open(e, "_self")
            ...
            D = z,
            N = (s("80ed"), Object(d["a"])(D, b, p, !1, null, "2982471c", null)),
            O = N.exports,
            w = function() {
                var e = this,
                    t = e.$createElement,
                    s = e._self._c || t;
                return s("div", {
                    class: "yes" === e.pass ? "code-warp-green" : "no" === e.pass ? "code-warp-red" : "blue" === e.pass ? "code-warp-blue" : "code-warp-fail"
                }, [e._m(0), s("div", {
                    staticClass: "info-warp"
                }, [s("div", {
                    staticClass: "avater"
                }, [e.faceImg && "null" !== e.faceImg ? s("img", {
                    attrs: {
                        src: e.faceImg,
                        alt: "头像加载失败"
                    }
                }) : s("div", {
                    staticClass: "iconfont-avater-img"
                }, [s("span", {
                    staticClass: "iconfont"
                }, [e._v("")])]), "yes" === e.pass ? s("span", {
                    staticClass: "iconfont iconfont-avater yes"
                }, [e._v("")]) : e._e(), "no" === e.pass ? s("span", {
                    staticClass: "iconfont iconfont-avater no"
                }, [e._v("")]) : e._e(), "blue" === e.pass ? s("span", {
                    staticClass: "iconfont iconfont-avater blue"
                }, [e._v("")]) : e._e(), "" === e.pass ? s("span", {
                    staticClass: "iconfont iconfont-avater fail"
                }, [e._v("")]) : e._e()]), s("div", {
                    staticClass: "user"
                }, [s("div", {
                    staticClass: "name"
                    ...
                    staticClass: "code"
                }, [e._v(e._s(e.userCode))])]), s("div", {
                    staticClass: "pass"
                }, [s("span", [e._v("通行权限：")]), "yes" === e.pass ? s("span", {
                    staticClass: "yes"
                }, [e._v("允许")]) : e._e(), "no" === e.pass ? s("span", {
                    staticClass: "no"
                }, [e._v("禁止")]) : e._e(), "blue" === e.pass ? s("span", {
                    staticClass: "blue"
                }, [e._v("未经审核")]) : e._e(), "" === e.pass ? s("span", {
                    staticClass: "fail"
                }, [e._v("获取失败")]) : e._e()]), s("div", {
                    staticClass: "address"
                }, [e._v(e._s(e.entrance)), s("span", [e._v(" " + e._s(e.actualVehicle))])]), s("div", {
                    staticClass: "time"
                }, [e._v(e._s(e.createTime))])]), e._m(1)])
            },
            W = [function() {
                var e = this,
                    t = e.$createElement,
            ...
            U = (s("ac1f"), s("1276"), s("b0c0"), {
                ...
                methods: {
                    ...
                    register: function(e) {
                        var t = this;
                        R(e).then((function(e) {
                            t.userCode = e.data[0].attributes.userCode, t.createTime = e.data[0].attributes.createTime, t.entrance = JSON.parse(e.data[0].attributes.entrance).data.name, t.actualVehicle = e.data[0].attributes.actualVehicle % 2 === 0 ? "入" : "出", "#006633" === e.data[0].attributes.ruleset.color ? t.pass = "yes" : "#10aeff" === e.data[0].attributes.ruleset.color ? t.pass = "blue" : t.pass = "no"
                        }))
                    }
                }
            }),
            k = U,
            x = (s("2357"), Object(d["a"])(k, w, W, !1, null, "30eea19e", null)),
            L = x.exports;
        c["a"].use(f["a"]);
        var V = [{
                path: "/",
